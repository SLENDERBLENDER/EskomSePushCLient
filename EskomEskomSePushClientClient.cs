namespace EskomSePushClient
{
    ...
    using EskomSePushClient.Responses;
    using helloserve.SePush;
    using Microsoft.Extensions.Logging;
    using Microsoft.Extensions.Options;

    public class EskomEskomSePushClientClient : IEskomSePushClient
    {
        static HttpClient httpClient;

        readonly ILogger<EskomEskomSePushClientClient> logger;
        readonly IOptionsMonitor<EskomSePushClientOptions> options;

        public EskomEskomSePushClientClient(IOptionsMonitor<EskomSePushClientOptions> options, ILogger<EskomEskomSePushClientClient> logger, HttpClient httpClient = null)
        {
            this.options = options;
            this.logger = logger;
            EskomEskomSePushClientClient.httpClient = httpClient ?? new HttpClient();
        }
        ...
        public async Task<Status> StatusAsync()
        {
            ...
            return await GetResponse<StatusResponse, Status>(request, r => r.Status).ConfigureAwait(false);
        }
